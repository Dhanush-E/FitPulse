...
function Beginner() {
  return (
    ...
    <div id="beg-container-out">
    
    <div className='beginner-box'>
      <h3 className="beg-h3">Pushups</h3>
     
      <h4 className='beg-h4'>Mon,Wed,Fri</h4>
      ...
      <h5 className='beg-h5'>15 Reps Per Day</h5>
    ...
    <div className='beginner-box'>
      <h3 className="beg-h3">Lunges</h3>
      
      <h4 className='beg-h4'>Tue,Thur,Fri</h4>
    ...
    <div className='beginner-box'>
      <h3 className="beg-h3">Brisk Walk</h3>
     
      <h4 className='beg-h4'>Mon,Wed,Sat</h4>
      ...
      <h5 className='beg-h5'>15 Min Walk Per Day</h5>
    ...
    <div className='beginner-box'>
      <h3 className="beg-h3">Planks</h3>
    
      <h4 className='beg-h4'>Tue,Wed,Sat</h4>
      ...
      <h5 className='beg-h5'>30 Second Per Day</h5>
    ...
    <div className='beginner-box'>
      <h3 className="beg-h3">Squats</h3>
     
      <h4 className='beg-h4'>Mon,Thur,Fri</h4>
    ...
    <div className='beginner-box'>
      <h3 className="beg-h3">Jumping Jacks</h3>
      
      <h4 className='beg-h4'> Tue,Thur,Sat</h4>
      ...
      <h5 className='beg-h5'>12 Reps Per Day</h5>
